...
const Index = () => (
  <Layout>
    ...
    <Container>
      ...
      <Ul>
        <Li>
          <Link to="https://google.com">Visual Studio Code</Link> is my editor
          of choice. It's fast, highly customizable and I really like working
          with it.
        </Li>
        <Li>
          I'm using the{' '}
        ...
        <Li>
          My font is "Menlo". It works fine for me, but I'm thinking of
          purchasing <Link to="https://dank.sh/">Dank Mono</Link> which looks
          awesome.
        </Li>
        <Li>
          If I'm doing stuff with PHP I prefer{' '}
          <Link to="https://www.jetbrains.com/phpstorm/">PhpStorm</Link>,
          because it's integration is the best.
        </Li>
      </Ul>
      <H2>Terminal</H2>
      <Ul>
        <Li>
          Currently I'm using <Link to="https://www.iterm2.com/">iTerm 2</Link>.
          I tried <Link to="https://hyper.is/">Hyper</Link> a while ago, but I
          had noticable delays when typing which was annoying. I might have to
          check it out again as it improved alot I heard.
        </Li>
        <Li>
          ...
          prompt. I don't use Oh My Zsh because I find it too bloated and too
          much magic I don't control.
        </Li>
        <Li>
      ...
      <Ul>
        <Li>
          ...
          <Link to="http://gatsbyjs.org">GatsbyJS</Link> (which uses React)
          which is awesome. It provides a progressive web app out of the box and
          it's a breeze to create new sites.
        </Li>
        <Li>
