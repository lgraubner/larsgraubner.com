...
export default () => (
  <Layout>
    ...
    <P>
      ...
      your browser automatically transmits to us in {'"'}
      server log files
      {'"'}. These are:
    </P>
    <ul>
    ...
    <P>
      ...
      uses so-called {'"'}
      cookies
      {'"'}. These are text files that are stored on your computer and that
      allow an analysis of the use of the website by you. For this purpose, the
      information generated by the cookie about the use of this website is
      stored on our server. The IP address is anonymized before it is stored.
    </P>
    ...
    <P>
      ...
      the newsletter at any time, e.g. through the {'"'}
      unsubscribe
      {'"'} link in the newsletter. The data processed before we receive your
