  ...
  <Layout>
    ...
    <Container>
      ...
      <P>
        ...
        charge. You also have the right to request that it be corrected,
      ...
      <P>
        ...
        collect and what we use it for. It also explains how and for what
        purpose this happens.
      </P>
      <P>
        Please note that data transmitted via the internet (e.g. via email
        communication) may be subject to security breaches. Complete protection
      ...
      <P>
        ...
        website operator has a legitimate interest in the storage of cookies to
        ensure an optimized service provided free of technical errors. If other
        cookies (such as those used to analyze your surfing behavior) are also
      ...
      <P>
        ...
        allow an analysis of the use of the website by you. For this purpose,
        the information generated by the cookie about the use of this website is
      ...
      <P>
        ...
        However, we wish to point out that doing so may mean you will not be
        able to enjoy the full functionality of this website.
      </P>
      <P>
        ...
        If you delete your cookies, this will mean that the opt-out cookie will
        also be deleted. You will then need to reactivate it when you return to
        our site if you wish your activity not to be tracked.
      </P>
      <iframe
        title="Matomo Optout"
        style={{
        ...
        src="https://analytics.larsgraubner.de/index.php?module=CoreAdminHome&action=optOut&language=en&backgroundColor=&fontColor=545454&fontSize=19px&fontFamily=-apple-system%2CBlinkMacSystemFont%2CSegoe%20UI%2CRoboto%2CHelvetica%2CArial%2Csans-serif"
      />
      <H2>5. Newsletter</H2>
      ...
      <P>
        ...
        only with your consent per Art. 6 (1) (a) DSGVO. You can revoke consent
        to the storage of your data and email address as well as their use for
        sending the newsletter at any time, e.g. through the {'"'}
        unsubscribe
